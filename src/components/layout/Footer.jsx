...
function Footer({ agentCount, positionCount, exchangeCount, tick, envEMA, envMult, trainingStatus }) {
  ...
  return (
    <footer style={s.footer} role="contentinfo">
      <span>Trade-SSM v3.0 \u00B7 RL Strategy Manager</span>
      <span>
        {agentCount} Agents \u00B7 {positionCount} Positions \u00B7 {exchangeCount} Exchanges
        {trainingStatus && (
          <span style={{ color: trainingStatus === "TRAINING" ? "#00e89d" : "#ff4976", marginLeft: 6 }}>
            \u00B7 RL: {trainingStatus}
          </span>
        )}
      </span>
